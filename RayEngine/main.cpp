...
// Scenes are constructed using the RayEngine object and pre-loaded into memory.
...
int main(int argc, char **argv) {
	...
	sponzaScene->camera.position = { -0.592655f, 157.009f, -0.962465f };
	...
	sponzaScene->setCameraPath(new LookPath(10.f));
#endif
	...
	sibenikScene->setCameraPath(new LookPath(15.f));
#endif
...
#if 0
	Scene* carScene = rayEngine.createScene("cars", "img/night.jpg", { 0.1f, 0.1f, 0.2f });
	carScene->loadObject("obj/sponza/stonefloor.obj");
	carScene->addLight({ 100.f, 200.f, 100.f }, { 1.f, 1.f, 1.f }, 1000.f);
	Object* car = carScene->loadObject("C:/Users/david/Documents/Visual Studio 2013/Projects/SimpleEmbree/Meshes/SLS/sls_amg.obj");
		->scale({ 50.f, 50.f, 50.f })
		->rotate({ 1, 0, 0 }, -90.f)
		->translate({ 0.f, 24.f, 25.f });
	carScene->setCameraPath(new CirclePath({ 0.f, 10.f, 0.f }, 180.f, M_PIf / 8.f, 15.f));
#endif
	...
	houseScene->loadObject("C:/Users/david/Documents/Visual Studio 2013/Projects/SimpleEmbree/Meshes/FutHouse/Futuristic rural house.obj");
